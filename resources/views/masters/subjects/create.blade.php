...
@section('title', 'Create Subject Master')
...
<div class="max-w-4xl mx-auto px-6 py-10">
    ...
    <div class="mb-8">
        ...
        <h2 class="text-3xl font-bold text-gray-900">Create Subject Master</h2>
        <p class="text-gray-600 mt-2">Add a new email subject template</p>
    </div>

    <!-- Form -->
    <form action="/masters/subjects" method="POST" class="bg-white rounded-xl border border-gray-100 p-8 space-y-6">
        @csrf
        ...
        <div>
            ...
            <textarea
                name="description"
                rows="6"
                placeholder="Enter the email subject template here..."
                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                required
